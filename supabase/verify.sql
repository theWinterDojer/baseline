  ...
  for rec in
    select * from (
      values
        ...
        ('goals', 'commitment_contract_address'),
  ...
  for rec in
    select * from (
      values
        ...
        ('goals', 'commitment_contract_address', 'text'),
  ...
  for rec in
    select * from (
      values
        ...
        ('public.goals_commitment_contract_address_idx'),
...
required_column_types(table_name, column_name, expected_data_type, expected_udt_name) as (
  values
    ...
    ('goals', 'commitment_contract_address', 'text', null),
